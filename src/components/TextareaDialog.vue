<!-- This file is being kept for backward compatibility during the refactoring process.
     ...
     TODO: Update all imports to reference @/shared/components/dialog/TextareaDialog.vue directly and remove this file. -->
<script>
import TextareaDialog from "@/shared/components/dialog/TextareaDialog.vue"
