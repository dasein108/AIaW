export default {
  firstVisit: {
    ...
    messageWithLogin:
      "AIaW 是全功能、輕量級、可拓展的 AI 客戶端。<br><br>為了使用 AI 模型，你需要<b>配置服務商（API）</b>或者<b>登入</b>。<br>登入之後，還可以使用跨裝置即時雲同步功能。",
    messageWithoutLogin:
      "AIaW 是全功能、輕量級、可拓展的 AI 客戶端。<br><br>為了使用 AI 模型，你需要<b>配置服務商（API）</b>。",
    cancel: "配置服務商",
    ok: "登入",
  },
  createDialog: {
