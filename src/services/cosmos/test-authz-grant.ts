...
const granterMnemonic = 'program vast lesson soldier lucky power cost tragic train combine minute wonder'
...
(async () => {
  ...
  const grantTx = await granterClient.signAndBroadcast(granterAccount.address, [
    {
