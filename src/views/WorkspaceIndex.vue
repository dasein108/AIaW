...
console.log('!!!!workspace index', workspace.value)

const contentMd = computed(() => engine.parseAndRenderSync(workspace.value.metadata.indexContent, { workspace: workspace.value }))
